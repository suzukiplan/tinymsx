...
2. REGISTER FUNCTIONS
  ...
  2.2. Status registers #0 to #9
    ...
    2.2.6. Status register #8
    2.2.7. Status register #9
3. SCREEN MODES
  3.1. TEXT1 mode
  3.2. TEXT2 mode
...
| S#7      |       |       |       |       |       |       |       |       | [Status register #7](#225-status-register-7)         |
| S#8      |       |       |       |       |       |       |       |       | [Status register #8](#226-status-register-8)         |
| S#9      |       |       |       |       |       |       |       |       | [Status register #9](#227-status-register-9)         |

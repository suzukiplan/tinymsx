...
2. REGISTER FUNCTIONS
  ...
  2.2. Status registers #0 to #9
    ...
    2.2.4. Status register #3
    2.2.5. Status register #4
    2.2.6. Status register #5
    2.2.7. Status register #6
    2.2.8. Status register #7
    2.2.9. Status register #8
    2.2.10. Status register #9
3. SCREEN MODES
  3.1. TEXT1 mode
  3.2. TEXT2 mode
...
> 各スクリーンモードの仕様については、「3. SCREEN MODES」で詳述します。
...
| S#3      |       |       |       |       |       |       |       |       | [Status register #3](#224-status-register-3)  |
| S#4      |       |       |       |       |       |       |       |       | [Status register #4](#225-status-register-4)  |
| S#5      |       |       |       |       |       |       |       |       | [Status register #5](#226-status-register-5)  |
| S#6      |       |       |       |       |       |       |       |       | [Status register #6](#227-status-register-6)  |
| S#7      |       |       |       |       |       |       |       |       | [Status register #7](#228-status-register-7)  |
| S#8      |       |       |       |       |       |       |       |       | [Status register #8](#229-status-register-8)  |
| S#9      |       |       |       |       |       |       |       |       | [Status register #9](#2210-status-register-9) |
